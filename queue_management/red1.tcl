...
set f2 [open tcp_red1.tr w]
set nf [open tcp_red1.nam w]
set f0 [open red_scenario1_receiver1.gr w]
set f1 [open red_scenario1_receiver2.gr w]
set f3 [open red_scenario1_total.gr w]
$ns namtrace-all $nf
$ns trace-all $f2
...
proc finish {} {
	...
	#Execute NAM on the trace file
 	exec nam tcp_red1.nam &

 	exec xgraph red_scenario1_receiver1.gr red_scenario1_receiver2.gr -geometry 800x400 &
 	exec xgraph red_scenario1_total.gr -geometry 800x400 &
...
$ns duplex-link $r2 $recv1 10Mb 1ms RED
$ns duplex-link $r2 $recv2 10Mb 1ms RED
