...
set nam_trace_fd [open tcp_red2.nam w]
$ns namtrace-all $nam_trace_fd

set f0 [open red_scenario2_receiver1.gr w]
set f1 [open red_scenario2_receiver2.gr w]
set f2 [open red_scenario2_receiver3.gr w]
set f3 [open red_scenario2_total.gr w]


# open the measurement output files
set trace_fd [open tcp_red2.tr w]
...
proc finish {} {
    ...
    exec xgraph red_scenario2_receiver1.gr red_scenario2_receiver2.gr red_scenario2_receiver3.gr -geometry 800x400 &
    exec xgraph red_scenario2_total.gr -geometry 800x400 &

    #Execute NAM on the trace file
    exec nam tcp_red2.nam &
    exit 0
}
